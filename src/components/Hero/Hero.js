    ...
    <div className='hero'>
      ...
      <div className='left-h'>
        ...
        <div className='hero-text'>
          ...
          <div>
            <span>
              sah<span style={{ textTransform: 'lowercase' }}>i</span>b olun
            </span>
          </div>
          <div>
            <span>
        ...
        <div className='hero-buttons'>
          ...
          <button className='btn'>
            <Link activeClass='active' to='Join' spy={true} smooth={true}>
              Əlaqə
            </Link>
          </button>
        </div>
      ...
      <div className='right-h'>
        <button className='btn button-effect' style={{ display: 'none' }}>
          Qoşulun
        </button>
        <motion.div
          initial={{ right: '-1rem' }}
